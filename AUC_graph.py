...
if __name__ == "__main__":
    ...
    feature_list = [500, 1000, 1500, 2000, 2250, 2500, 2750, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000]
    #feature_list = [8000]
    ...
    sr_AUC.to_pickle('AUC_sr_9_8k_large.pkl')
    filename = 'logfit_8000_9'
